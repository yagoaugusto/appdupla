        ...
        <main class="flex-1 p-2 sm:p-6 bg-gradient-to-br from-blue-100 via-white to-red-100 min-h-screen flex flex-col items-center justify-start">
            ...
            <form id="formPlacar" action="controller-partida/salvar-partida.php" method="POST" class="w-full space-y-6">
                ...
                <div class="flex items-center gap-2 mt-2">
                    ...
                    <input required type="text" id="jogador3" class="input input-bordered w-full text-xs focus:ring-2 focus:ring-red-400 bg-white" placeholder="Busque o adversário..." autocomplete="off" style="background-color:#fff;color:#222;-webkit-text-fill-color:#222;">
                ...
                <div class="flex items-center gap-2 mt-3">
                    ...
                    <input required type="text" id="jogador4" class="input input-bordered w-full text-xs focus:ring-2 focus:ring-red-400 bg-white" placeholder="Busque o parceiro do adversário..." autocomplete="off" style="background-color:#fff;color:#222;-webkit-text-fill-color:#222;">
