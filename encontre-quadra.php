...
<body class="bg-gray-50">
    ...
    <header class="bg-white/80 backdrop-blur-md shadow-sm fixed w-full z-40">
        <div class="navbar max-w-7xl mx-auto">
            ...
            <div class="navbar-end gap-2">
                ...
                <a href="cadastrar.php" class="btn btn-primary">Cadastre-se</a>
            </div>
        </div>
    </header>
    ...
    <main class="pt-24">
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <!-- Filter Section -->
            <div class="bg-white/90 backdrop-blur-sm p-4 rounded-2xl shadow-md border border-gray-200 mb-8 sticky top-20 z-30">
                <form method="GET" action="encontre-quadra.php" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                    <div class="form-control">
                        <label for="data" class="label-text font-semibold pb-1 text-sm">Data</label>
                        <input type="date" id="data" name="data" value="<?= htmlspecialchars($data_selecionada) ?>" class="input input-bordered input-primary w-full">
                    </div>
                    <div class="form-control">
                        <label for="hora_inicio" class="label-text font-semibold pb-1 text-sm">Das</label>
                        <select id="hora_inicio" name="hora_inicio" class="select select-bordered select-primary w-full">
                    ...
                    <div class="form-control">
                        <label for="hora_fim" class="label-text font-semibold pb-1 text-sm">Até</label>
                        <select id="hora_fim" name="hora_fim" class="select select-bordered select-primary w-full">
            ...
            function createPopupContent(arena) {
                ...
                return `
                    <div class="font-sans w-64">
                        ...
                        <div class="mt-3">
                            <a href="index.php" class="btn btn-xs btn-primary w-full">Ver Arena e Agendar</a>
                        </div>
                    </div>
                `;
            }
