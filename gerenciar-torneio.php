    ...
    <div class="flex pt-16">
        ...
        <main class="flex-1 p-4">
            <section class="mx-auto w-full bg-white rounded-2xl shadow-xl p-6 md:p-8"> <!-- Removido max-w-4xl -->
                ...
                <!-- Abas de Navegação -->
                <div role="tablist" class="tabs tabs-bordered tabs-lifted mb-6"> 
                    <input type="radio" name="my_tabs" role="tab" class="tab" aria-label="📊" checked />
                    ...
                    <input type="radio" name="my_tabs" role="tab" class="tab" aria-label="👥" />
                    <div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6">
                    ...
                    <input type="radio" name="my_tabs" role="tab" class="tab" aria-label="🏷️" />
                    <div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6">
                        <h3 class="font-bold text-lg mb-4 flex items-center gap-2"><span class="text-xl">🏷️</span> Categorias do Torneio</h3>
